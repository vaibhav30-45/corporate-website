...
const ManageBlogs = () => {
 ...
 const fetchBlogs = async () => {
    ...
    try {
      ...
      setError(
        err.response?.data?.message ||
          "Failed to save blog. Please check all fields.",
      );
    } finally {
      setSubmitting(false);
    }
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500">
            View, add, edit or remove insights from your website.
          </p>
        </div>
        <motion.button
  ...
  className="flex items-center justify-center gap-2 bg-primary text-white px-6 py-3 rounded-xl font-bold hover:bg-orange-700 transition-all shadow-lg active:scale-95"
>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        {loading ? (
          ...
          <div className="py-20 text-center">
            ...
            <p className="text-gray-500">
              Try adjusting your search or add a new blog.
            </p>
          </div>
        ) : (
              ...
              <div className="px-8 py-6 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
                <div>
                  ...
                  <p className="text-gray-500 text-sm">
                    Manage your blog content and metadata in one place.
                  </p>
                </div>
                <button
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          >
                            ...
                            <option value="Governance Perspectives">
                            ...
                            <option value="Corridor Analysis">
                              Corridor Analysis
                            </option>
                          </select>
                        </div>
              ...
              <div className="px-8 py-6 border-t border-gray-100 bg-white flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <button
                    ...
                    form="blogForm"
                    disabled={submitting}
                    className="bg-primary text-white px-8 py-3 rounded-xl font-bold hover:bg-navy-900 transition-all shadow-lg shadow-corporate-navy/20 disabled:opacity-50 flex items-center gap-2"
                  >
                    {submitting ? (
                      <>
                      ...
                      <span>
                        {currentBlog ? "Save Changes" : "Publish Blog"}
                      </span>
                    )}
                  </button>
                </div>
          ...
          <div className="fixed inset-0 z-[70] flex items-center justify-center p-4 bg-corporate-navy/40 backdrop-blur-sm animate-in fade-in duration-300">
            ...
            >
              ...
              <p className="text-gray-500 mb-8">
                ...
                <span className="font-bold">"{currentBlog?.title}"</span>? This
