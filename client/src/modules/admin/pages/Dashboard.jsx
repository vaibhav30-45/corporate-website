...
import { markAsRead } from "../../../redux/slices/enquiryAdminSlice";
...
// console.log("Jobs data =", jobs.data);
        ...
        setStats({
  totalPosts: blogs.length + news.length,
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1">
            Real-time statistics and management tools for your platform.
          </p>
        </div>
        <div className="flex gap-3">
          ...
          <Link
            ...
            className="flex items-center gap-2 text-white px-6 py-2.5 rounded-xl font-bold text-sm transition-all active:scale-95"
          >
            Review Enquiries
          </Link>
        </div>
        ...
        {statCards.map((stat, index) => (
          ...
          >
            <div className="absolute top-0 right-0 p-4 opacity-0 group-hover:opacity-100 transition-opacity">
              <ArrowUpRight
                size={20}
                className="text-gray-300 group-hover:text-corporate-orange"
              />
            </div>
            <div className="flex justify-between items-start mb-5">
              <div
                className={`${stat.color} p-4 rounded-2xl group-hover:scale-110 transition-transform duration-300`}
              >
                {stat.icon}
              </div>
              {stat.badge && (
          ...
          <div className="p-8 border-b border-gray-50 flex justify-between items-center">
            <div>
              ...
              <p className="text-sm text-gray-400 mt-0.5">
                Stay updated with your latest business leads
              </p>
            </div>
            <Link
              to="/admin/enquiries"
              className="text-corporate-orange text-sm font-bold flex items-center gap-1 hover:underline"
            >
            ...
            {recentEnquiries.length > 0 ? (
              recentEnquiries.map((enquiry, index) => (
                <div
                  ...
                  className="p-6 hover:bg-gray-50 transition-colors group cursor-pointer flex items-center justify-between"
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-bold text-corporate-navy group-hover:text-corporate-orange transition-colors">
                        {enquiry.name}
                      </p>
              ...
              <div className="p-12 text-center">
                ...
                <p className="text-gray-500 text-sm mt-1">
                  Check back later for new business leads.
                </p>
              </div>
            )}
          </div>
