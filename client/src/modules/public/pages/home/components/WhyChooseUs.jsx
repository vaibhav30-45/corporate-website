    ...
    <section className="w-full overflow-hidden bg-[#0c2438]">
      <div className="flex flex-col lg:flex-row min-h-[520px]">
        ...
        <div className="relative w-full lg:w-[50%] bg-[#0c2438] text-white flex items-center">
          ...
          {/* DESKTOP DIAGONAL */}
         <div className="hidden lg:block absolute top-0 -right-24 w-48 h-[110%] bg-[#0c2438] skew-x-[-12deg] origin-top z-20"></div>
...
>
  ...
  <p>
    NIOSTGROUP International is not being built as a conventional holding
    company. Its structure is intended to support stronger oversight,
    clearer capital discipline, and better alignment between governance,
    market strategy, and long-term value creation.
  </p>
</motion.div>
            {/* STATS */}
           {/* FEATURES */}
...
<div className="flex flex-col gap-5 max-w-[520px] mt-8">
  ...
  className="bg-white/5 border border-white/10 rounded-xl p-5 hover:border-orange-500/40 transition"
>
...
>
    ...
    <p className="text-sm text-gray-300 leading-relaxed">
      ...
      model grounded in strategic clarity, operating alignment,
      and control.
    </p>
</motion.div>
